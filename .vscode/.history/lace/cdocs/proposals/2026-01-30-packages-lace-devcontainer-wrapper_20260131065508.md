...
> NOTE(mjr):
> - Please use arktype, typescript, vite, vitest for tooling
...
>     but later we want to refine/boil down the test suite for maintainability and semantic content, avoiding the "test volume == quality coverage" fallicy
