...
- **Lifecycle observability.** The parent proposal's lifecycle module knows whether host portless is alive; this RFP must specify how it surfaces the bind port (`:80` vs `:1355`) and how a sysctl-not-applied state is reported.
