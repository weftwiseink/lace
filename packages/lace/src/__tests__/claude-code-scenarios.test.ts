...
// NOTE(opus/prebuild-removal): C7 (claude-code in the removed prebuild block)
// removed with the legacy-builder-cache migration; C1 already covers mount
// auto-injection for a feature in top-level `features`.
